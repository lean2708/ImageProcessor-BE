...
def histogram_equalization(id1, output_folder="output_images/"):
    """
    Process the input image with histogram_equalization and save
    ...
    # Histogram equalization cho từng kênh
    ...
    ima.save(output_path)  # Save file
    a2 = str(encode_image(output_path))

    processed_image = {
        'base64': a2,
        'image_size': (w, h),
        'output_file': output_filename  # trả về tên file để biết lưu ở đâu
    }
